...
<div id="wrap" class="wrap_main insurance" style="position: relative; overflow: hidden; background-image: none; height: 453px; min-height: 1500px;">
    ...
    <div id="container" class="step">
        ...
        <div id="contents">
            <form id="sForm" action="" method="POST" novalidate="novalidate">
                <input type="hidden">
                            ...
                            <dl>
                                ...
                                <dd class="step">
                                    ...
                                    <ul class="icon_gender">
                                        <li>
                                            <label for="gdcd1" class="input_radio rad">
                                                <input id="gdcd1" name="gdcd" type="radio" value="1"
                                                    aria-roledescription="all-error">
                                                <span>남</span>
                                            </label>
                                        </li>
                                        <li>
                                            <label for="gdcd2" class="input_radio rad">
                                                <input id="gdcd2" name="gdcd" type="radio" value="2"
                                                    aria-roledescription="all-error">
                                                <span>여</span>
                                            </label>
                                        </li>
                            ...
                            <dl class="job_sch">
                                ...
                                <dd class="sch">
                                    <span class="wrap_input" style="width: 400px;">
                                        <input type="text" id="jobNm" name="jobNm" class="txt_inp inp_b"
                                            title="직업정보 검색" readonly="readonly" placeholder="직업정보 검색"
                                            style="width: 400px;">
                                    </span>
                                    <a href="" class="icon_sch_input">
...
<!-- 직업 찾기 -->
<div id="popNoteJoinLayer2" class="wrap_popup" style="z-index: 215; left: 503.5px; top: 0px; position: absolute;">
        ...
        <div class="wrap_pop">
            ...
            <div class="wrap_cont_sc find_job">
                <div class="wrap_pop_cont">
                    ...
                    <div id="_btn_job_complete_" class="btn_center mgt50" style="display: block;">
                        <a href="#" class="btns btn_pop_green">
                            <span>완료</span>
                        </a>
                    </div>
